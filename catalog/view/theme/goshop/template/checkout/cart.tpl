      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
              ...
              &nbsp;
              <input type="image" src="catalog/view/theme/<?php echo $config->get( 'theme_default_directory' ); ?>/img/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
              &nbsp;<a onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><img src="catalog/view/theme/<?php echo $config->get( 'theme_default_directory' ); ?>/img/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a>
          </td>
