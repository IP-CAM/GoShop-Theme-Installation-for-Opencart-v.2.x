...
<head>
	...
	<?php include('catalog/view/theme/'.$config->get($config->get('config_theme') . '_directory').'/css/custom_colors.php'); ?>
    ...
    if($theme_options->get( 'fixed_header' ) == 1) { ?>
        <script type="text/javascript" src="catalog/view/theme/<?php echo $config->get($config->get('config_theme') . '_directory'); ?>/js/jquery.sticky.js"></script>
    <?php } ?>
							...
							<div class="container">
								<div class="row">
									...
									<div class="col-sm-6" id="top-bar-right">
										<ul class="menu">
										     <li><a href="<?php echo $account; ?>" class="main"><?php echo $text_account; ?></a></li>
										     <li><?php echo $cart; ?></li>
										     <li><a href="<?php echo $checkout; ?>" class="main"><?php echo $text_checkout; ?></a></li>
										</ul>
									</div>
								</div>
							</div>
