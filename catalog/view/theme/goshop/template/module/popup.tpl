<div id="popup-<?php echo $module_id; ?>" class="popup <?php if($background_color == '#fff') { echo 'popup-white '; } if(!$ajax) { echo 'mfp-hide'; } ?>" style="<?php if($content_width > 100) { echo 'max-width: ' . $content_width . 'px;'; } if($background_color != '') { echo 'background-color: ' . $background_color . ';'; } if($background_image != '') { echo 'background-image: url(image/' . $background_image . ');background-position: ' . $background_image_position . ';background-repeat: ' . $background_image_repeat . ';'; } ?>">
     <?php 
          if($type == 1) {
               echo '<div class="popup-newsletter">';
                    if($newsletter_popup_title != '') echo '<h5>' . $newsletter_popup_title . '</h5>';
