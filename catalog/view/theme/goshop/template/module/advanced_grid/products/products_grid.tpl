...
$class = 3; 
$all = 4;
$id2 = rand(0, 5000)*rand(5000, 50000);
...
<div class="box clearfix box-with-products <?php if($module['content']['title'] == '') { echo 'without-heading'; } ?>" style="margin-top: -14px">
  <?php if($module['content']['title'] != '') { ?>
  <div class="box-heading"><?php echo html_entity_decode($module['content']['title']); ?></div>
  <?php } ?>
  <div class="box-content products">
    <div class="box-product">
    	<div id="myCarousel<?php echo $id2; ?>">
    		<!-- Carousel items -->
