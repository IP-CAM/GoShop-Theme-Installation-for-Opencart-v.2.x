...
class ControllerModuleAdvancedGrid extends Controller {
	public function index($setting) {
		...
		return $this->load->view('module/advanced_grid/advanced_grid', $data);
	}
	               ...
	               if($module['type'] == 'latest_blogs') {
                        ...
                        foreach ($results as $result) {
                            ...
                            $data['articles'][] = array(
                                ...
                                'tags' => $tags_array,
                                'readmore' => $this->language->get('button_read_more'),
	               ...
	               if($module['type'] == 'newsletter') {
	                    ...
	                    if(isset($module['newsletter']['title'][$this->config->get('config_language_id')])) {
	                         $content = array(
	                              ...
	                              'subscribe_url' => $this->url->link('module/newsletter/subscribe', '', true),
	                              'unsubscribe_url' => $this->url->link('module/newsletter/unsubscribe', '', true)
	                         );
	                    } else {
	                         $content = array(
	                              'title' => 'Set name!',
