...
class ControllerModulePopup extends Controller {
	public function index($setting) {
		...
		$data['subscribe_url'] = $this->url->link('module/newsletter/subscribe', '', true);
		$data['unsubscribe_url'] = $this->url->link('module/newsletter/unsubscribe', '', true);
		$data['contact_url'] = $this->url->link('module/popup/contact', '', true);
     	     ...
     	     foreach($modules as $setting) {
     	          if($setting['module_id'] == $module_id) {
		               ...
		               $data['show_only_once'] = $setting['show_only_once'];
     	               ...
     	               echo $this->load->view('module/popup', $data);
     	          }
     	     }
	     }
	}
