	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=module/goshop&store_id=' . $store['store_id'] . '&token=' . $_GET['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
					...
					<div id="tab_install_data" class="tab-content">
						...
						<div class="input" style="border: none">
							...
							<select name="select_demo" id="select_demo">
							     ...
							     <option value="2" <?php if($select_demo == '2'){echo ' selected="selected"';} ?>>default2</option>
							     <option value="3" <?php if($select_demo == '3'){echo ' selected="selected"';} ?>>fashion</option>
							     <option value="4" <?php if($select_demo == '4'){echo ' selected="selected"';} ?>>electronics</option>
							     <option value="5" <?php if($select_demo == '5'){echo ' selected="selected"';} ?>>electronics2</option>
							     <option value="6" <?php if($select_demo == '6'){echo ' selected="selected"';} ?>>electronics3</option>
							     <option value="7" <?php if($select_demo == '7'){echo ' selected="selected"';} ?>>fashion & accessories</option>
							     <option value="8" <?php if($select_demo == '8'){echo ' selected="selected"';} ?>>fashion & accessories2</option>
							     <option value="9" <?php if($select_demo == '9'){echo ' selected="selected"';} ?>>fashion & accessories3</option>
							     <option value="10" <?php if($select_demo == '10'){echo ' selected="selected"';} ?>>jewelry</option>
							     <option value="11" <?php if($select_demo == '11'){echo ' selected="selected"';} ?>>jewelry2</option>
							     <option value="12" <?php if($select_demo == '12'){echo ' selected="selected"';} ?>>jewelry3</option>
							     <option value="13" <?php if($select_demo == '13'){echo ' selected="selected"';} ?>>shoes</option>
							     <option value="14" <?php if($select_demo == '14'){echo ' selected="selected"';} ?>>shoes2</option>
							     <option value="15" <?php if($select_demo == '15'){echo ' selected="selected"';} ?>>shoes3</option>
							     <option value="16" <?php if($select_demo == '16'){echo ' selected="selected"';} ?>>sunglasses</option>
							     <option value="17" <?php if($select_demo == '17'){echo ' selected="selected"';} ?>>sunglasses2</option>
							     <option value="18" <?php if($select_demo == '18'){echo ' selected="selected"';} ?>>sunglasses3</option>
							</select>
						...
						<div class="input versions version-1 version-2 version-3 version-4 version-5 version-6 version-7 version-8 version-9 version-10 version-11 version-12 version-13 version-14 version-15 version-16 version-17 version-18">
						...
						<div class="input versions version-1 version-2 version-3">
						...
						<div class="input versions version-3 version-6 version-9 version-12 version-15 version-18" style="display: none">
