...
$output["advanced_grid_module"] = array (
  ...
  array (
    ...
    array (
     ...
     <div class="col-sm-6" style="background: #f8f8f8 url(image/catalog/jewelry/promotion-1.jpg) bottom right no-repeat">
          <div class="promotion" style="float: right">
               <div class="name">Waterproof Watch</div>
     ...
     <div class="col-sm-6" style="background: #f0f0f0 url(image/catalog/jewelry/promotion-2.jpg) bottom left no-repeat">
          <div class="promotion">
               <div class="name">Golden Ring</div>
...
$(document).ready(function() {
  ...
  array (
    ...
    array (
     ...
     <div class="first-heading">Found your <span>Dream Jewelry</span>? Why wait</div>
     <div class="second-heading">Get it now with a 0% finance deal from GoShop Jewelry..</div>
</div>',
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/bg-new-arrivals.jpg',
 ...
 <div class="col-sm-4"><a href="#"><img src="image/catalog/jewelry/banner-04.jpg" alt="Image"></a></div>
 <div class="col-sm-4"><a href="#"><img src="image/catalog/jewelry/banner-05.jpg" alt="Image"></a></div>
 <div class="col-sm-4"><a href="#"><img src="image/catalog/jewelry/banner-06.jpg" alt="Image"></a></div>
 </div>',
