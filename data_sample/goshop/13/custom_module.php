  ...
  array (
    ...
    array (
     ...
     <div class="col-sm-4">
          ...
          <img src="image/catalog/shoes/banner-01.jpg" alt="Banner">
     </div>
     ...
     <div class="col-sm-4">
          ...
          <img src="image/catalog/shoes/banner-02.jpg" alt="Banner">
     </div>
     
     <div class="col-sm-4">
          <div class="description left">
               <div class="first-heading">SHOES <span>$550</span></div>
               <p>Jeans, Clothing, Accessories and many more...</p>
               <a href="#" class="button">Shop now</a>
          </div>     
          <img src="image/catalog/shoes/banner-03.jpg" alt="Banner">
     </div>
</div>',
     ...
     <div class="box-content">
          <div class="special-offers row">
               <div class="col-sm-6 col-lg-4">
                    <div class="product">
                         <div class="image"><a href="index.php?route=product/product&product_id=43"><img src="image/catalog/shoes/product-1.jpg" alt="Product"></a></div>
                         <div class="right">
                              <p>Mountain shoes</p>
               ...
               <div class="col-sm-6 col-lg-4">
                    <div class="product">
                         <div class="image"><a href="index.php?route=product/product&product_id=43"><img src="image/catalog/shoes/product-2.jpg" alt="Product"></a></div>
                         <div class="right">
                              <p>Mountain shoes</p>
               ...
               <div class="col-sm-6 col-lg-4">
                    <div class="product">
                         <div class="image"><a href="index.php?route=product/product&product_id=43"><img src="image/catalog/shoes/product-3.jpg" alt="Product"></a></div>
                         <div class="right">
                              <p>Mountain shoes</p>
                              <div class="name"><a href="index.php?route=product/product&product_id=43">GT SENSOR COMP 27.5</a></div>
                              <div class="price">Price: <span class="price-new">$299.00</span> <span class="price-old">$599.00</span></div>
               ...
               <div class="col-sm-6 col-lg-4">
                    <div class="product">
                         <div class="image"><a href="index.php?route=product/product&product_id=43"><img src="image/catalog/shoes/product-4.jpg" alt="Product"></a></div>
                         <div class="right">
                              <p>Mountain shoes</p>
                              <div class="name"><a href="index.php?route=product/product&product_id=43">BREEZER SQUALL 1.0</a></div>
                              <div class="price">Price: <span class="price-new">$299.00</span> <span class="price-old">$599.00</span></div>
               ...
               <div class="col-sm-6 col-lg-4">
                    <div class="product">
                         <div class="image"><a href="index.php?route=product/product&product_id=43"><img src="image/catalog/shoes/product-5.jpg" alt="Product"></a></div>
                         <div class="right">
                              <p>Mountain shoes</p>
                              <div class="name"><a href="index.php?route=product/product&product_id=43">GT SENSOR COMP 27.5</a></div>
                              <div class="price">Price: <span class="price-new">$299.00</span> <span class="price-old">$599.00</span></div>
               ...
               <div class="col-sm-6 col-lg-4">
                    <div class="product">
                         <div class="image"><a href="index.php?route=product/product&product_id=43"><img src="image/catalog/shoes/product-6.jpg" alt="Product"></a></div>
                         <div class="right">
                              <p>Mountain shoes</p>
                              <div class="name"><a href="index.php?route=product/product&product_id=43">GT SENSOR COMP 27.5</a></div>
                              <div class="price">Price: <span class="price-new">$299.00</span> <span class="price-old">$599.00</span></div>
