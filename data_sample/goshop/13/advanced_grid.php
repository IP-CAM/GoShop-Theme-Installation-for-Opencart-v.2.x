...
$output["advanced_grid_module"] = array (
  ...
  array (
    ...
    'background_image' => 'catalog/shoes/bg-choose-your-shoes.jpg',
    ...
    array (
     ...
     <div class="box-heading">Choose your <span>shoes</span></div>
     <div class="second-heading">Search by type of shoes</div>
     <div class="box-content text-center">
          <div class="roundabout">     
               ...
               <ul>
                    <li>
                         <div class="image"><img src="image/catalog/shoes/shoes-1.png" alt="" /></div>
                         <div class="name"><a href="#">Shoes MD.41</a></div>
                         <div class="price"><span>Start from</span> $599.00</div>
                    </li>
                    <li>
                         <div class="image"><img src="image/catalog/shoes/shoes-2.png" alt="" /></div>
                         <div class="name"><a href="#">Shoes FX</a></div>
                         <div class="price"><span>Start from</span> $299.00</div>
                    </li>
                    <li>
                         <div class="image"><img src="image/catalog/shoes/shoes-3.png" alt="" /></div>
                         <div class="name"><a href="#">Shoes MD. 123</a></div>
                         <div class="price"><span>Start from</span> $399.00</div>
                    </li>
               </ul>
          </div>
          
          <a href="#" class="button" style="margin-bottom: 97px">View all jewelry</a>
     </div>
</div>
...
<script type="text/javascript">
  ...
  array (
    ...
    array (
     ...
     <div class="col-sm-6" style="background: #f8f8f8 url(image/catalog/shoes/promotion-1.jpg) bottom right no-repeat">
     ...
     <div class="col-sm-6" style="background: #f0f0f0 url(image/catalog/shoes/promotion-2.jpg) bottom left no-repeat">
          <div class="promotion">
  ...
  array (
    ...
    'padding_left' => '0',
    'force_full_width' => '1',
    'background_color' => '#434142',
    'background_image_type' => '1',
    'background_image' => 'catalog/shoes/bg-contact.jpg',
    ...
    array (
     ...
     <img src="image/catalog/shoes/logo-footer.png" style="margin-bottom: 6px" alt="Logo"><br>
...
<div class="partner">
  ...
  array (
    ...
    array (
     ...
     <img src="image/catalog/shoes/logo-footer.png" alt="GoPro">
...
$(document).ready(function() {
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/shoes/bg-testimonials.jpg',
    'background_image_position' => 'top center',
    'background_image_repeat' => 'no-repeat',
    'background_image_attachment' => 'scroll',
    'layout_id' => '1',
...
$(document).ready(function() {
     ...
     <div class="box-content">     
          <div class="row row-without-padding featured-products">
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/shoes/featured-product-1.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Shoes</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/shoes/featured-product-2.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Shoes</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/shoes/featured-product-3.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Shoes</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/shoes/featured-product-4.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Shoes</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/shoes/featured-product-5.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Shoes</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/shoes/featured-product-6.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Shoes</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/shoes/featured-product-7.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Shoes</div>
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/shoes/bg-camera.jpg',
    'background_image_position' => 'top center',
    'background_image_repeat' => 'no-repeat',
    'background_image_attachment' => 'scroll',
    'layout_id' => '1',
  ...
  array (
    ...
    array (
     ...
     <div class="first-heading">Found your <span>Dream Shoes</span>? Why wait</div>
     <div class="second-heading">Get it now with a 10% finance deal from GoShop Shoes..</div>
</div>',
