...
$output["advanced_grid_module"] = array (
  ...
  array (
    ...
    array (
     ...
     <div class="col-sm-6" style="background: #f2f2ed url(image/catalog/bg-winter-jacket.jpg) top left no-repeat">
          <div class="clearfix">
               <div class="promotion2" style="float: right">
                    <div class="first-heading">Popular Products</div>
                    <div class="second-heading"><span>Winter</span> jacket</div>
                    <div class="description">PRE SEASON EVENT AT OUR <b>NEW ARRIVAL</b><br>
                    <i>*Discount applied automatically at checkout</i></div>
                    <a href="#" class="button5">Shop all jacket now</a>
               </div>
          </div>
     </div>
     
     <div class="col-sm-6" style="background: #906d68 url(image/catalog/bg-end-of-season.jpg) top right no-repeat">
          <div class="clearfix">
  ...
  array (
    ...
    array (
     ...
     <img src="image/catalog/logo-footer-fashion.png" alt="GoPro">
...
$(document).ready(function() {
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/bg-testimonials2.jpg',
...
$(document).ready(function() {
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/bg-free-your-run.jpg',
    'background_image_position' => 'top center',
    'background_image_repeat' => 'no-repeat',
    'background_image_attachment' => 'scroll',
    'layout_id' => '1',
