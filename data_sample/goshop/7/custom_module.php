  ...
  array (
    ...
    array (
     ...
     <div class="col-sm-4">
          ...
          <img src="image/catalog/accessories/banner-01.jpg" alt="Banner">
     </div>
     ...
     <div class="col-sm-4">
          ...
          <img src="image/catalog/accessories/banner-02.jpg" alt="Banner">
     </div>
     
     <div class="col-sm-4">
          <div class="description left">
               <div class="first-heading">JEANS <span>$550</span></div>
               <p>Jeans, Clothing, Accessories and many more...</p>
               <a href="#" class="button">Shop now</a>
          </div>     
          <img src="image/catalog/accessories/banner-03.jpg" alt="Banner">
     </div>
</div>',
