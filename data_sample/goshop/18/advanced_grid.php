...
$output["advanced_grid_module"] = array (
  ...
  array (
    ...
    array (
     ...
     <div class="col-sm-6" style="background: #eaeae2 url(image/catalog/sunglasses/bg-promotion-1.jpg) top left no-repeat">
          <div class="clearfix">
               <div class="promotion2" style="float: right">
                    <div class="first-heading">Popular Products</div>
                    <div class="second-heading"><span>Sport</span> glass</div>
                    <div class="description">PRE SEASON EVENT AT OUR <b>NEW ARRIVAL</b><br>
                    <i>*Discount applied automatically at checkout</i></div>
                    <a href="#" class="button5">Shop all glasses now</a>
               </div>
          </div>
     </div>
     
     <div class="col-sm-6" style="background: #a07e77 url(image/catalog/sunglasses/bg-promotion-2.jpg) top right no-repeat">
          <div class="clearfix">
               <div class="promotion2 color2">
                    <div class="first-heading">Trending Glasses</div>
                    <div class="second-heading"><span>End of</span> season</div>
                    <div class="description">PRE SEASON EVENT AT OUR <b>NEW ARRIVAL</b><br>
                    <i>*Discount applied automatically at checkout</i></div>
                    <a href="#" class="button5">Shop glasses & accessories</a>
               </div>
          </div>
     </div>
</div>',
...
$(document).ready(function() {
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/sunglasses/bg-free-your-run.jpg',
    'background_image_position' => 'top center',
    'background_image_repeat' => 'no-repeat',
    'background_image_attachment' => 'scroll',
    'layout_id' => '1',
