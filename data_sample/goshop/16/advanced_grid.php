...
$output["advanced_grid_module"] = array (
  ...
  array (
    ...
    'background_image' => 'catalog/sunglasses/bg-choose-your-sunglasses.jpg',
    ...
    array (
     ...
     <div class="box-heading">Choose your <span>sunglasses</span></div>
     <div class="second-heading">Search by type of sunglasses</div>
     <div class="box-content text-center">
          <div class="roundabout">     
               ...
               <ul>
                    <li>
                         <div class="image"><img src="image/catalog/sunglasses/sunglasses-2.png" alt="" /></div>
                         <div class="name"><a href="#">Sunglasses MD.41</a></div>
                         <div class="price"><span>Start from</span> $599.00</div>
                    </li>
                    <li>
                         <div class="image"><img src="image/catalog/sunglasses/sunglasses-1.png" alt="" /></div>
                         <div class="name"><a href="#">Sunglasses FX</a></div>
                         <div class="price"><span>Start from</span> $299.00</div>
                    </li>
                    <li>
                         <div class="image"><img src="image/catalog/sunglasses/sunglasses-3.png" alt="" /></div>
                         <div class="name"><a href="#">Sunglasses MD. 123</a></div>
                         <div class="price"><span>Start from</span> $399.00</div>
                    </li>
               </ul>
          </div>
          
          <a href="#" class="button" style="margin-bottom: 97px">View all sunglasses</a>
     </div>
</div>
...
<script type="text/javascript">
  ...
  array (
    ...
    array (
     ...
     <div class="col-sm-6" style="background: #f8f8f8 url(image/catalog/sunglasses/promotion-1.jpg) bottom right no-repeat">
          <div class="promotion" style="float: right">
               <div class="name">Sport Shoes</div>
               <div class="brand">Men <span>$350</span></div>
               
               <ul class="features">
                    <li>Extreme high quality</li>
                    <li>Perfect production details</li>
                    <li>Soft and clean design</li>
               </ul>
     ...
     <div class="col-sm-6" style="background: #f0f0f0 url(image/catalog/sunglasses/promotion-2.jpg) bottom left no-repeat">
          <div class="promotion">
               <div class="name">Elegant Shoes</div>
  ...
  array (
    ...
    'background_image_type' => '1',
    'background_image' => 'catalog/sunglasses/bg-contact.jpg',
    ...
    array (
     ...
     <img src="image/catalog/sunglasses/logo-footer.png" style="margin-bottom: 6px" alt="Logo"><br>
...
<div class="partner">
  ...
  array (
    ...
    array (
     ...
     <img src="image/catalog/sunglasses/logo-footer.png" alt="GoPro">
...
$(document).ready(function() {
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/sunglasses/bg-testimonials.jpg',
    'background_image_position' => 'top center',
    'background_image_repeat' => 'no-repeat',
    'background_image_attachment' => 'scroll',
    'layout_id' => '1',
...
$(document).ready(function() {
     ...
     <div class="box-content">     
          <div class="row row-without-padding featured-products">
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/sunglasses/featured-product-1.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality sunglasses</div>
                              <div class="name"><a href="#">Shoe PRO FX - 33</a></div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/sunglasses/featured-product-2.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality sunglasses</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/sunglasses/featured-product-3.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality sunglasses</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/sunglasses/featured-product-4.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality sunglasses</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/sunglasses/featured-product-5.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality sunglasses</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/sunglasses/featured-product-6.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality sunglasses</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/sunglasses/featured-product-7.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality sunglasses</div>
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/sunglasses/bg-camera.jpg',
    'background_image_position' => 'top center',
    'background_image_repeat' => 'no-repeat',
    'background_image_attachment' => 'scroll',
    'layout_id' => '1',
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            array (
              1 => '<div class="box">
     <div class="box-heading">ECO LEATHER <span>CERVELO</span></div>
  ...
  array (
    ...
    array (
     ...
     <div class="first-heading">Found your <span>Dream Sunglasses</span>? Why wait</div>
     <div class="second-heading">Get it now with a 10% finance deal from GoShop Sunglasses..</div>
</div>',
