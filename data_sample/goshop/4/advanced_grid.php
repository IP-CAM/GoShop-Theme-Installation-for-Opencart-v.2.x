...
$output["advanced_grid_module"] = array (
  ...
  array (
    ...
    'background_image' => 'catalog/electronics/bg-choose-your-bike.jpg',
    ...
    array (
     ...
     <div class="box-heading">Choose your <span>camera</span></div>
     <div class="second-heading">Search by type of camera</div>
     <div class="box-content text-center">
          <div class="roundabout">     
               ...
               <ul>
                    <li>
                         <div class="image"><img src="image/catalog/electronics/camera-1.png" alt="" /></div>
                         <div class="name"><a href="#">CAMERA MD.41</a></div>
                         <div class="price"><span>Start from</span> $599.00</div>
                    </li>
                    <li>
                         <div class="image"><img src="image/catalog/electronics/camera-2.png" alt="" /></div>
                         <div class="name"><a href="#">Camera Pro FX</a></div>
                         <div class="price"><span>Start from</span> $299.00</div>
                    </li>
                    <li>
                         <div class="image"><img src="image/catalog/electronics/camera-3.png" alt="" /></div>
                         <div class="name"><a href="#">CAMERA MD. 123</a></div>
                         <div class="price"><span>Start from</span> $399.00</div>
                    </li>
               </ul>
          </div>
          
          <a href="#" class="button" style="margin-bottom: 97px">View all cameras</a>
     </div>
</div>
...
<script type="text/javascript">
     $(".roundabout ul").roundabout({
         ...
         autoplayPauseOnHover: true
              ...
              $language_id => '<div class="box with-arrow">
     <div class="box-heading">Choose your <span>camera</span></div>
     <div class="second-heading">Search by type of camera</div>
     <div class="box-content text-center">
          <div class="roundabout">     
...
<script type="text/javascript">
  ...
  array (
    ...
    array (
     ...
     <div class="col-sm-6" style="background: #f8f8f8 url(image/catalog/electronics/promotion-1.jpg) bottom right no-repeat">
          <div class="promotion" style="float: right">
               <div class="name">Waterproof Camera</div>
               <div class="brand">MD.PRO <span>$350</span></div>
               
               <ul class="features">
                    <li>Perfect clean blend coolpix</li>
                    <li>High shooter speed 4.6 - 110.4 mm</li>
                    <li>24x optical zoom ED VR</li>
               </ul>
     ...
     <div class="col-sm-6" style="background: #f0f0f0 url(image/catalog/electronics/promotion-2.jpg) bottom left no-repeat">
          <div class="promotion">
               <div class="name">Waterproof Camera</div>
               <div class="brand">MD.344 <span>$250</span></div>
              ...
              $language_id => '<div class="clearfix row row-without-padding">
     <div class="home-discount"><div>Discount up to 75%</div></div>
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/electronics/bg-contact.jpg',
    ...
    array (
     ...
     <img src="image/catalog/electronics/logo-footer.png" style="margin-bottom: 6px" alt="Logo"><br>
...
<div class="partner">
     <div class="container">
          <ul>
              ...
              $language_id => '<div class="address text-center">
     <img src="image/catalog/electronics/logo-footer.png" style="margin-bottom: 6px" alt="Logo"><br>
     148 Parramatta Road Stanmore NSW 2048, New York City<br>
     Call Sales & Workshop : (02) 9567 1999
     <h5>Opening hours</h5>
...
<div class="partner">
  ...
  array (
    ...
    array (
     ...
     <img src="image/catalog/electronics/logo-footer.png" alt="GoPro">
     ...
     <ul class="social-icons">
          ...
          <li><a href="#"><i class="fa fa-behance"></i></a></li>
              ...
              $language_id => '<div class="about-us">
     <img src="image/catalog/electronics/logo-footer.png" alt="GoPro">
     <p>Ecommerce OC Template</p>
     <ul class="social-icons">
          <li><a href="#"><i class="fa fa-twitter"></i></a></li>
          ...
          array (
            ...
            array (
              ...
              array (
                ...
                $language_id => 'Lorem ipsum dolor sit amet conseret adipiscing elit sed diam nonunem.',
              ),
              'input_placeholder' => 
              array (
                1 => 'Your Email',
...
$(document).ready(function() {
     $("#owl-example").owlCarousel({
         ...
         navigationText : ["←","→"],
              ...
              $language_id => '<div class="overflow-payments">
     <div id="owl-example" class="owl-carousel footer-payments">
          <div><a href="#"><img src="image/catalog/payment-1.png" alt="Payment"></a></div>
          <div><a href="#"><img src="image/catalog/payment-2.png" alt="Payment"></a></div>
          <div><a href="#"><img src="image/catalog/payment-4.png" alt="Payment"></a></div>
...
$(document).ready(function() {
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/electronics/bg-testimonials.jpg',
    'background_image_position' => 'top center',
    'background_image_repeat' => 'no-repeat',
    'background_image_attachment' => 'scroll',
    'layout_id' => '1',
...
$(document).ready(function() {
     $("#testimonials").owlCarousel({
         ...
         navigationText : ["",""]
              ...
              $language_id => '<div class="overflow-testimonials">
     <div id="testimonials" class="owl-carousel testimonials">
          <div class="item text-center">
               <div class="testimonial">
                    <div class="first-heading">They says</div>
...
$(document).ready(function() {
     ...
     <div class="box-content">     
          <div class="row row-without-padding featured-products">
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/electronics/featured-product-1.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Cameras</div>
                              <div class="name"><a href="#">CAMERA PRO FX - 33</a></div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/electronics/featured-product-2.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Cameras</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/electronics/featured-product-3.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Cameras</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/electronics/featured-product-4.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Cameras</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/electronics/featured-product-5.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Cameras</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/electronics/featured-product-6.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Cameras</div>
               ...
               <div class="col-sm-6 col-lg-3">
                    <div class="image"><img src="image/catalog/electronics/featured-product-7.png" alt="Product"></div>
                    <div class="description">
                         <div class="text">
                              <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              <div class="brand">Quality Cameras</div>
  ...
  array (
    ...
    'background_color' => '',
    'background_image_type' => '1',
    'background_image' => 'catalog/electronics/bg-camera.jpg',
    'background_image_position' => 'top center',
    'background_image_repeat' => 'no-repeat',
    'background_image_attachment' => 'scroll',
    'layout_id' => '1',
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            array (
              1 => '<div class="box">
     <div class="box-heading">PRO CAMERA <span>CERVELO</span></div>
  ...
  array (
    ...
    array (
     ...
     <div class="first-heading">Found your <span>Camera</span>? Why wait</div>
     <div class="second-heading">Get it now with a 10% finance deal from GoShop Electronics..</div>
</div>',
              $language_id => '<div class="found-your-dream clearfix">
     <div class="buttons">
          <a href="#" class="button button2">Discover</a>
          <a href="#" class="button">Purchase</a>
     </div>
          ...
          array (
            ...
            array (
              ...
              array (
                ...
                $language_id => '<span>New</span> arrivals',
              ),
              'description' => 
              array (
                1 => 'Trending Products',
                $language_id => 'Trending Products',
              ),
              'width' => '270',
              'height' => '285',
              'limit' => '4',
          ...
          array (
            ...
            array (
              ...
              array (
                ...
                $language_id => 'Subscribe newsletter <p>Sign Up for <span>Special Promotion</span></p>',
              ),
              'text' => 
              array (
                ...
                $language_id => '<b>Lorem ipsum dolor sit amet</b>,  consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. ',
              ),
              'input_placeholder' => 
              array (
          ...
          array (
            ...
            array (
              ...
              array (
                ...
                $language_id => 'Related products <p>Customers who viewed this item also viewed</p>',
              ),
              'get_products_from' => 'random',
              'product' => '',
              'products' => '',
